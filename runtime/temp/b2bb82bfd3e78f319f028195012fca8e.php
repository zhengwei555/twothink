<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\www\twothink\public/../application/admin/view/default/sale\index.html";i:1507199297;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
		...
		<table>
			...
			<tbody>
				<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$baoxiu): $mod = ($i % 2 );++$i;?>
					<tr>
						<td><input class="ids row-selected" type="checkbox" name="id[]" id="" value="<?php echo $baoxiu['id']; ?>"> </td>
						<td><?php echo $baoxiu['id']; ?></td>
						<td><?php echo $baoxiu['name']; ?></td>
						<td><?php echo $baoxiu['tel']; ?></td>
						<td><?php echo $baoxiu['tail']; ?></td>
						<td><?php echo $baoxiu['price']; ?></td>
						<td><?php echo time_format($baoxiu['create_time']); ?></td>
						<td><?php echo time_format($baoxiu['update_time']); ?></td>
                        <td><?php echo $baoxiu['status_text']; ?></td>
						<td>
