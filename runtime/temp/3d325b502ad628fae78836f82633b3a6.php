<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\www\twothink\public/../application/admin/view/default/sale\edit.html";i:1507199436;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="tail" value="<?php echo (isset($info['tail']) && ($info['tail'] !== '')?$info['tail']:''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">价格<span class="check-tips">（必填）</span></label>
			<div class="controls">
