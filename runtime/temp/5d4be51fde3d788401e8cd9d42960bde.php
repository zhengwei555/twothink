<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\www\twothink\public/../application/admin/view/default/renzheng\edit.html";i:1507203932;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">住户编号<span class="check-tips">（必填）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="sn" value="<?php echo (isset($info['sn']) && ($info['sn'] !== '')?$info['sn']:''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">小区地址<span class="check-tips">（必填）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="area_name" value="<?php echo (isset($info['area_name']) && ($info['area_name'] !== '')?$info['area_name']:''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">身份证<span class="check-tips">（必填）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="ID_card" value="<?php echo (isset($info['ID_card']) && ($info['ID_card'] !== '')?$info['ID_card']:''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">与住户关系<span class="check-tips">（必填）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="relationship" value="<?php echo (isset($info['relationship']) && ($info['relationship'] !== '')?$info['relationship']:''); ?>">
			</div>
		</div>
