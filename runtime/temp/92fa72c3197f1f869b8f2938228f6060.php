<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\www\twothink\public/../application/admin/view/default/renzheng\index.html";i:1507204170;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
			...
			<tbody>
				<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$baoxiu): $mod = ($i % 2 );++$i;?>
					<tr>
						...
						<td><?php echo $baoxiu['area_name']; ?></td>
						<td><?php echo $baoxiu['ID_card']; ?></td>
						<td><?php echo $baoxiu['relationship']; ?></td>
