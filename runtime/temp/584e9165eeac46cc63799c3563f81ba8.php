<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\www\twothink\public/../application/admin/view/default/service\index.html";i:1507549978;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tr>
            ...
            <td><?php echo $service['status_text']; ?></td>
            <td>
                <a title="编辑" href="<?php echo url('edit?id='.$service['id'].'&pid='.$pid); ?>">编辑</a>
                <a href="<?php echo url('setStatus?ids='.$service['id'].'&status='.abs(1-$service['status'])); ?>" class="ajax-get"><?php echo show_status_op($baoxiu['status']); ?></a>
