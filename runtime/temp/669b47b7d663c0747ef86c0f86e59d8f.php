<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\www\twothink\public/../application/admin/view/default/activity\index.html";i:1507549366;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tr>
            <td><input class="ids row-selected" type="checkbox" name="id[]" id="" value="<?php echo $activity['id']; ?>"> </td>
            ...
            <td><?php echo $activity['status_text']; ?></td>
            <td>
                <a title="编辑" href="<?php echo url('edit?id='.$activity['id'].'&pid='.$pid); ?>">编辑</a>
                <a href="<?php echo url('setStatus?ids='.$activity['id'].'&status='.abs(1-$activity['status'])); ?>" class="ajax-get"><?php echo show_status_op($baoxiu['status']); ?></a>
