<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\www\twothink\public/../application/admin/view/default/life\index.html";i:1507549903;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tr>
            ...
            <td><?php echo $life['status_text']; ?></td>
            <td>
                <a title="编辑" href="<?php echo url('edit?id='.$life['id'].'&pid='.$pid); ?>">编辑</a>
                <a href="<?php echo url('setStatus?ids='.$life['id'].'&status='.abs(1-$life['status'])); ?>" class="ajax-get"><?php echo show_status_op($baoxiu['status']); ?></a>
